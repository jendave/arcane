...
public class FlagRenderer extends PaddedRenderer {
    /** Constant <code>indexToFlag</code> */
    static public Map<Integer, Flag> indexToFlag = new LinkedHashMap();
    /** Constant <code>greyFlagImage</code> */
    ...
    /**
     * <p>Constructor for FlagRenderer.</p>
     *
     * @param table a {@link arcane.ui.table.CardTable} object.
     * @param modelFlagColumn a int.
     */
