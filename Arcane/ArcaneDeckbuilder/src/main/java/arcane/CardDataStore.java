...
public class CardDataStore extends DataStore<CardDataStore.CardDataStoreConnection> {
    /**
     * <p>Constructor for CardDataStore.</p>
     *
    ...
    public final class CardDataStoreConnection extends DataStore.DataStoreConnection {
        ...
        private final PreparedStatement pictureToCollectorNumbers;

        public PreparedStatement getPictureToCollectorNumbers() {
            return pictureToCollectorNumbers;
        }
        ...
        private CardDataStoreConnection() throws SQLException {
            ...
            pictureToCollectorNumbers = prepareStatement("SELECT pictureNumber, collectorNumber FROM :table: "
