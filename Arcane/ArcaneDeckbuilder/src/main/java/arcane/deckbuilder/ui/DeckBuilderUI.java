...
abstract class DeckBuilderUI extends ArcaneFrame {
    ...
    private CardTable sideTable;

    /**
     * <p>Constructor for DeckBuilderUI.</p>
     *
                    ...
                    bottomRightSplit.add(deckSection, SplitPane.RIGHT);
                    {
                        ...
                        }
                        {
                                    ...
                                    GridBagConstraints.BOTH, new Insets(0, 4, 4, 4), 0, 0));
                            {
                                ...
                                {
                                    setDeckTable(new CardTable(true));
                                    deckScrollPane.setViewportView(getDeckTable());
                                }
                            }
                            {
                                ...
                                {
                                    setSideTable(new CardTable(true));
                                    sideScrollPane.setViewportView(getSideTable());
                                    getDeckTable().copyTable(getSideTable());
                                    getSideTable().copyTable(getDeckTable());
                                }
                            }
                        }
                    }
    ...
    /**
     * <p>Getter for the field <code>deckInfoPanel</code>.</p>
     *
    ...
    /**
     * <p>Setter for the field <code>deckTable</code>.</p>
     *
     * @param deckTable a {@link arcane.ui.table.CardTable} object.
     */
    public void setDeckTable(CardTable deckTable) {
        this.deckTable = deckTable;
    }

    /**
     * <p>Getter for the field <code>deckTable</code>.</p>
     *
     * @return a {@link arcane.ui.table.CardTable} object.
     */
    public CardTable getDeckTable() {
        return deckTable;
    }

    /**
     * <p>Setter for the field <code>sideTable</code>.</p>
     *
     * @param sideTable a {@link arcane.ui.table.CardTable} object.
     */
    public void setSideTable(CardTable sideTable) {
        this.sideTable = sideTable;
    }

    /**
     * <p>Getter for the field <code>sideTable</code>.</p>
     *
     * @return a {@link arcane.ui.table.CardTable} object.
     */
    public CardTable getSideTable() {
        return sideTable;
    }
