...
public class CardTable extends SortedTable {
     ...
     * @param hiddenProperties a {@link arcane.CardProperty} object.
     */
     ...
     * <p>copyTable</p>
     *
     * @param copyTable a {@link arcane.ui.table.CardTable} object.
     */
    ...
    public void tableChanged(TableModelEvent evt) {
        ...
        outerLoop:
        for (Component component : columnsMenu.getMenuComponents()) {
